...
const Cliente = ({cliente, handleEliminar}) => {
    ...
    const { id, nombre, empresa, email, notas, telefono } = cliente
    return (
        <tr className="border hover:bg-gray-50 transition-all">
            ...
            <td className="p-3">
                ...
                <button
                    type="button"
                    className="bg-yellow-500 hover:bg-yellow-600 block w-full text-white p-2 uppercase font-bold text-xs mt-1"
